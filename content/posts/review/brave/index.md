...
description: "Braveというプライバシーを守り、広告からも守ってくれるウェブブラウザを使ってみました。とても好感触もちました。iPhoneでも使ってみようと思ってます。" # add description
summary: "Braveというプライバシーを守り、広告からも守ってくれるウェブブラウザを使ってみました。とても好感触もちました。iPhoneでも使ってみようと思ってます。"
draft: false
---
...
{{<figure src="tk_20220918-914.webp" alt="brave image" width="700px" height="700px" >}}
...
簡単なレポートが確認できるます。URL の右側の 🦁（=brave ロゴ)をクリックすると、「トラッカーや広告」をブロックした数が表示されています。
...
iPhone や iPad だと、さらに威力を発揮するかも…。これから入れてみます〜 ❣️
